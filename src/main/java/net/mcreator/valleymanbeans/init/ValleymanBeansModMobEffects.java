...
public class ValleymanBeansModMobEffects {
	...
	public static final RegistryObject<MobEffect> VALLEYMAN_BEANS_POITION = REGISTRY.register("valleyman_beans_poition", () -> new ValleymanbeanspoitionPotionEffectMobEffect());
}
